			<h3>Recently Visited Products</h3><div class='row'>
				...
				if ($result->num_rows > 0) {
					while($row = $result->fetch_assoc()) {
                        ...
                        echo "<div class='caption'><h5 class='pull-right'>".$row['price']."</h5><h5><a href='src/product.php?id=".$row['id']."'>".$row['name']."</a></h5>";
